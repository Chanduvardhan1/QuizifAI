...
export default () => {
    return [
        ...
        {
            path:'print-quizresults',
            component: Printquizresults,
            isPrivate: true
        ...
        {
           path:'quizview_results',
           component: Quizresults1,
           isPrivate: true
        },
        {
            path:'quizview',
        ...
        {
            path:'quizcreated1',
            component: Quizcreated1,
            isPrivate: true
        },
        {
            path:'quizcreated2',
            component: Quizcreated2,
            isPrivate: true
        },
        {
            path:'quizaccess',
            component: QuizAccess,
            isPrivate: true
        },
        {
            path:'schedule',
        ...
        {
            path:'userandgroups',
            component: UserAndGroups,
        },
        
        {
            path:'papertemplates',
            component: PaperTemplates,
