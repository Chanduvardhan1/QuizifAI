...
const category = () => {
  ...
  useEffect(() =>{
     ...
     fetch('https://quizifai.com:8010/categories&sub_categories/')
  ...
  return (
    ...
    <div className='flex w-full flex-col'>
      <div className='flex justify-end mt-[30px]'>
        <div className='w-[118px] h-[30px] rounded-[10px] bg-[#F3D0D5] mr-[10px]'>
      ...
      <table className='h-[20px] table-auto mt-[30px] mx-[20px] rounded text-left bg-[#F3D0D5] text-[#214082] text-[13px] font-light'>
        ...
        <tbody className='bg-white border-gray-500 '>
          {filteredData.map(category => (
              ...
              <td className='px-4 py-2 border border-gray-500  text-[#214082] font-medium text-[10px]'>{category.category_id}</td>
              <td className='px-4 py-2 border border-gray-500  text-[#214082] font-medium text-[10px]'>{category.category_name}</td>
              <td className='px-4 py-2 border border-gray-500  text-[#214082] font-medium text-[10px]'>{category.category_description}</td>
              <td className='px-4 py-2 border border-gray-500  text-[#214082] font-medium text-[10px]'>
          ...
          <div key={category.sub_categories[0].sub_category_id}>
            {category.sub_categories[0].sub_category_name}
              ...
              <td className='h-full border border-gray-500 flex gap-2 pl-[40px] pt-2'>
                <img
        ...
        <tbody>
          {categories.map((category, index) => (
            <tr key={index} className='bg-white text-[#214082] font-medium text-[10px]'>
              <td className='px-4 py-2 border border-gray-500 '>{category.id}</td>
              <td className='px-4 py-2 border border-gray-500 '>{category.category}</td>
              <td className='px-4 py-2 border border-gray-500 '>{category.category_description}</td>
              <td className='px-4 py-2 border border-gray-500 '>{category.parent_category}</td>
