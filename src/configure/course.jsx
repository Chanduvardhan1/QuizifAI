    ...
    {courses.length > 0 ? (
      courses.map((course) => (
        <tr key={course.course_id}>
          ...
          <td className='px-4 py-2 border text-[#214082] font-bold text-[10px] text-start'>{course.course_code}</td>
          <td className='px-4 py-2 border text-[#214082] font-bold text-[10px] text-start'>{course.course_pattern}</td>
          <td className='px-4 py-2 border text-[#214082] font-bold text-[10px] text-center'>{course.duration}</td>
      ...
      <tr>
        <td colSpan="6" className='px-4 py-2 text-center text-[#214082] font-bold'>
          No data available
        </td>
      </tr>
    )}
