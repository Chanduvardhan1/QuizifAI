      ...
      <div className={styles.mainContent}>
        ...
        <div className={styles.contentWrapper1}>
          <div className={styles.latestQuizHeader}>
            <p className="text-[16px] font-Poppins -ml-[18.5px]">Latest Quiz</p>
          ...
          <div className={styles.topScoredHeader}>
            <p className="text-[16px] font-Poppins -ml-1">Top Scored</p>
          </div>
          <div className={styles.infoCards}>
...
<div
                  ...
                  >
                    ...
                    <div className={styles.category}>
                      <span className={styles.category1}>
                        {allquizzes[13]?.category}
                        <span className={styles.category11}>{allquizzes[13]?.category}</span>
                      </span>
                      <p className={styles.line}>|</p>
                      <span className={styles.category2}>
                        {allquizzes[13]?.sub_category}
                        <span className={styles.category22}>{allquizzes[13]?.sub_category}</span>
                      </span>
                    </div>

                    <div className={styles.description}>
                      <span className={styles.description1}>{allquizzes[13]?.quiz_description}
                      <span className={styles.subdescription}>{allquizzes[13]?.quiz_description}</span>
                      </span>
                    </div>
                    <div
                      className={styles.additionalInfo}
                    ...
                    >
                      ...
                      <div className="z-0">
                        <div className="flex gap-[5px] h-[18px] w-[105px] pt-[4px] rounded text-[#002366]  relative -left-[10px] -top-[90px] hover:text-black ">
                          <img
                            ...
                            height={10}
                          />
                          <p>{allquizzes[13]?.quiz_attempts}</p>
                          <span className="text-[6px] ml-1">attempts</span>
                        </div>
                      </div>
                      ...
                      <span className="flex pl-[2px] pt-[1.5px] -mt-[89.5px] gap-[3px] text-[#002366] h-[18px] w-[106px] rounded  relative -left-[12px] hover:text-black">
                        <img
                          ...
                          height={10}
                        />{" "}
                        {allquizzes[13]?.number_of_questions}
                        <span className="text-[6px] ml-[1px]">questions</span>
                      </span>
                      <span className="flex pl-[2px] pt-[2px] pb-[2px] -mt-[0.5px] gap-[5px] text-[#002366] h-[18px] w-[106px] rounded  relative -left-[14px] hover:text-black ">
                        <img
                  ...
                  >
                    ...
                    <div className={styles.category}>
                      <span className={styles.category1}>
                        {allquizzes[14]?.category}
                        <span className={styles.category11}>{allquizzes[14]?.category}</span>
                      </span>
                      <p className={styles.line}>|</p>
                      <span className={styles.category2}>
                        {allquizzes[14]?.sub_category}
                        <span className={styles.category22}>{allquizzes[14]?.sub_category}</span>
                      </span>
                    </div>

                    <div className={styles.description}>
                      <span className={styles.description1}>{allquizzes[14]?.quiz_description}
                      <span className={styles.subdescription}>{allquizzes[14]?.quiz_description}</span>
                      </span>
                    </div>
                    <div
                      className={styles.additionalInfo}
                    ...
                    >
                      ...
                      <div className="z-0">
                        <div className="flex gap-[5px] h-[18px] w-[105px] pt-[4px] rounded text-[#002366]  relative -left-[10px] -top-[90px] hover:text-black ">
                          <img
                            ...
                            height={10}
                          />
                          <p>{allquizzes[14]?.quiz_attempts}</p>
                          <span className="text-[6px] ml-1">attempts</span>
                        </div>
                      </div>
                      ...
                      <span className="flex pl-[2px] pt-[1.5px] -mt-[89.5px] gap-[3px] text-[#002366] h-[18px] w-[106px] rounded  relative -left-[12px] hover:text-black">
                        <img
                          ...
                          height={10}
                        />{" "}
                        {allquizzes[14]?.number_of_questions}
                        <span className="text-[6px] ml-[1px]">questions</span>
                      </span>
                      <span className="flex pl-[2px] pt-[2px] pb-[2px] -mt-[0.5px] gap-[5px] text-[#002366] h-[18px] w-[106px] rounded  relative -left-[14px] hover:text-black ">
                        <img
                  ...
                  >
                    ...
                    <div className={styles.category}>
                      <span className={styles.category1}>
                        {allquizzes[15]?.category}
                        <span className={styles.category11}>{allquizzes[15]?.category}</span>
                      </span>
                      <p className={styles.line}>|</p>
                      <span className={styles.category2}>
                        {allquizzes[15]?.sub_category}
                        <span className={styles.category22}>{allquizzes[15]?.sub_category}</span>
                      </span>
                    </div>

                    <div className={styles.description}>
                      <span className={styles.description1}>{allquizzes[15]?.quiz_description}
                      <span className={styles.subdescription}>{allquizzes[15]?.quiz_description}</span>
                      </span>
                    </div>
                    <div
                      className={styles.additionalInfo}
                    ...
                    >
                      ...
                      <div className="z-0">
                        <div className="flex gap-[5px] h-[18px] w-[105px] pt-[4px] rounded text-[#002366]  relative -left-[10px] -top-[90px] hover:text-black ">
                          <img
                            ...
                            height={10}
                          />
                          <p>{allquizzes[15]?.quiz_attempts}</p>
                          <span className="text-[6px] ml-1">attempts</span>
                        </div>
                      </div>
                      ...
                      <span className="flex pl-[2px] pt-[1.5px] -mt-[89.5px] gap-[3px] text-[#002366] h-[18px] w-[106px] rounded  relative -left-[12px] hover:text-black">
                        <img
                          ...
                          height={10}
                        />{" "}
                        {allquizzes[15]?.number_of_questions}
                        <span className="text-[6px] ml-[1px]">questions</span>
                      </span>
                      <span className="flex pl-[2px] pt-[2px] pb-[2px] -mt-[0.5px] gap-[5px] text-[#002366] h-[18px] w-[106px] rounded  relative -left-[14px] hover:text-black ">
                        <img
