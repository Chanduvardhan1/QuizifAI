    ...
    const fetchUsers = async () => {
      ...
      try {
        const response = await fetch(
          `https://dev.quizifai.com:8010/organization-users-details/?org_id=${orgId}`,
          {
            method: "GET",
            headers: {
    ...
    <div className="flex w-full">
        ...
        <thead className="bg-[#CBF2FB]">
          <tr className="text-[14px]">
            ...
            <th className="py-2 px-4 border-b">Attempted Quizzes</th>
        ...
        <tbody>
          {filteredUsers.map((user, index) => (
            ...
            >
              ...
              <td className="py-2 px-2 border-b text-start text-nowrap">
                {user.email}
              </td>
              <td className="py-2 px-4 border-b text-start text-nowrap">
                {user.role}
              </td>
              <td className="py-2 px-4 border-b text-start">{user.status}</td>
              <td className="py-2 px-4 border-b text-start text-nowrap">
                {user.last_login_at}
              </td>
...
export default organizationusesdetails;
