...
const handleBackToDashboard = () => {
  ...
  return (
    ...
    <div className="container mx-auto overflow-hidden p-4">
        ...
        <h1 className="text-3xl font-semibold mb-4">QuizifAI Terms and Conditions</h1>
        <section className="bg-white shadow-md rounded-md p-6">
            ...
            <p className="list-disc list-inside mb-4">Children below 12 years old can use the QuizifAI application with parents' credentials/approval/supervision.</p>
            <h2 className="text-xl font-semibold mb-4">Privacy and Safety Guidelines</h2>
            <p className="list-disc list-inside mb-4">Personal Information: Your privacy matters. We don't ask for personal details unless necessary, and we keep them safe.</p>
            <h2 className="text-xl font-semibold mb-4">Stay Safe Tips</h2>
            <p className="list-disc list-inside mb-4">Speak Up: If something doesn't feel right, talk to a trusted adult or use the report feature.</p>
            ...
            <p className="list-disc list-inside mb-4">You may not reproduce, distribute, or modify any content without prior written consent.</p>
            <h2 className="text-xl font-semibold mb-4">Limitation of Liability</h2>
            <p>We strive to provide a reliable Service, but we do not guarantee uninterrupted or error-free operation.</p>
            <p className="list-disc list-inside mb-4">We are not liable for any damages arising from the use or inability to use the Service.</p>
            <h2 className="text-xl font-semibold mb-4">Right to Modify</h2>
            <p className="list-disc list-inside mb-4">Reserve the right to update the terms and conditions and how users will be notified.</p>
